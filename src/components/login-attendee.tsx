...
import {attendeeSignIn} from '../store/slices/authSlice';
...
export function AttendeeLoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    try {
      ...
      const data = await dispatch(attendeeSignIn({email: formData.email, password: formData.password}));
        ...
        <Card className='mx-auto max-w-sm mt-10'>
          <CardHeader className='text-center'>
            ...
            <CardDescription className='text-gray-500 mt-2'>
              Access your account and stay informed about upcoming events
            </CardDescription>
          </CardHeader>
          <CardContent>
